...
Project skills live in `.cursor/skills/`. Cursor agents use these automatically when working on related tasks.
...
Human-readable overview: [docs/SKILLS.md](../docs/SKILLS.md)
