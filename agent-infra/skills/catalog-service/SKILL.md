...
description: Develop and test the FastAPI catalog_service microservice in humachine ecommerce. Use when adding product CRUD routes, catalog store logic, validation schemas, pytest tests, or Docker setup for services/catalog_service.
---
...
Port mapping: host `8002` → container `8002`
